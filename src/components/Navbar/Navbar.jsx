    ...
    >
      <Container className="navbar-container">
        <Navbar.Brand to="/">
          ...
          <h1 className="logo">Jodhpur-Mart</h1>
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="justify-content-end flex-grow-1 pe-3">
            ...
            <Nav.Item className="expanded-cart">
              ...
              {loggedIn ? (
                <>
                  <span className="nav-link-label">Logged in as: {email}</span>
                  <Link aria-label="Go to Login Page" className="navbar-link" to="/login" onClick={() => {
